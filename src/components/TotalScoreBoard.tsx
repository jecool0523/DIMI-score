...
const TotalScoreBoard = () => {
  ...
  return (
    <div className="w-full flex justify-center bg-transparent z-10 absolute top-0 left-0 pointer-events-none">
      <div
        className="content-stretch flex items-center relative shrink-0 bg-transparent overflow-hidden w-[1920px] h-[120px]"
      >
        {/* Team A Bar (Blue) */}
        <motion.div
        ...
        >
          {/* Left Score */}
          <div className="absolute font-sans leading-none font-black text-white whitespace-nowrap m-0 tracking-tighter z-20 left-[45px] text-[120px] top-[-23px]">
        ...
        >
          {/* Right Score */}
          <div className="absolute font-sans leading-none font-black text-[#0081ff] whitespace-nowrap m-0 text-right tracking-tighter z-20 right-[45px] text-[120px] top-[-23px]">

    ...
    <div className="w-full flex justify-center bg-transparent z-10 absolute top-0 left-0 pointer-events-none">
      <div className="content-stretch flex items-center relative w-[1920px] shrink-0 h-[120px] bg-transparent overflow-hidden">
        ...
        >
          ...
          <div className="absolute font-sans font-bold leading-[normal] left-[45px] text-[120px] text-white top-[-15px] whitespace-nowrap m-0 tracking-tighter z-20">
        ...
        >
          ...
          <div className="absolute font-sans font-bold leading-[normal] right-[45px] text-black text-[120px] top-[-15px] whitespace-nowrap m-0 text-right tracking-tighter z-20">

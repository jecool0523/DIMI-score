...
import { Monitor, Play, AlertTriangle, Plus, Minus, RotateCcw, Send, Lock, Clock, Info } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      ...
      <section className="mb-8">
        <div className="p-4 bg-primary/5 border border-primary/20 rounded-xl flex items-center gap-4 max-w-3xl">
          <div className="bg-primary/10 p-2 rounded-lg text-primary">
            <Info size={24} />
          </div>
          <div>
            <h2 className="text-lg font-semibold text-foreground leading-tight">자동 화면 전환 활성화됨</h2>
            <p className="text-sm text-muted-foreground mt-1">메인 화면은 하단의 <b>종목 관리</b> 상태에 따라 자동으로 전환됩니다.</p>
          </div>
        </div>
      </section>
